...
-- insert pathways
INSERT INTO model_draft.reeem_pathway_schedule (pathway,times_version,model_run,description,schedule,updated) VALUES
    ('BASE_TI1_P1',         -- V1
    'TIMES_V1', 
    'BASE_TI1_P1_TIMES_V1', 
    'TIMES_V1: the current version of TIMES PanEU', 
    'Oct 2017 - Nov 2017', 
    now() ),
    ('BASE_TI1_P2', 
    'TIMES_V1', 
    'BASE_TI1_P2_TIMES_V1', 
    'TIMES_V1: the current version of TIMES PanEU', 
    'Oct 2017 - Nov 2017', 
    now() ),
